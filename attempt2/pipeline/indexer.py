"""
Numpy-based indexer with BGE-M3 embeddings.
Stores embeddings + metadata as pickle for fast load.
"""
import numpy as np
import pickle
import logging
...
def search_index(query_vec, data, top_k=50):
    """Cosine similarity search (vectors are pre-normalized)."""
